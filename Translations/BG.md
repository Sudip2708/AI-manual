...
[ *Повече информация по тази тема ще намерите в самия* [***AI Manual***](../EN/Manual_for_AI.md), *който е написан на английски и съдържа по-подробен анализ на темата.* ]
...
[*Назад към съдържанието*](#съдържание)  • [*Връзка към основния наръчник*](../EN/Manual_for_AI.md)
